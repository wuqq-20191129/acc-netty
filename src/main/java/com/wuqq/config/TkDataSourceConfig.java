 ...
 */
@Configuration
@MapperScan(basePackages = "com.wuqq.dao.tk",sqlSessionFactoryRef = "tkSqlSesssionFactory")
public class TkDataSourceConfig {
    ...
    @Bean(name = "tkTransactionManager")
    public DataSourceTransactionManager cmTransactionManager() {
        return new DataSourceTransactionManager(tkDataSource());
    }

    @Bean(name = "tkSqlSesssionFactory")
    public SqlSessionFactory cmSqlSessionFactory(@Qualifier("tkDataSource") DataSource masterDataSource)
            throws Exception {
        final SqlSessionFactoryBean sessionFactory = new SqlSessionFactoryBean();
        sessionFactory.setDataSource(masterDataSource);
        sessionFactory.setMapperLocations(new PathMatchingResourcePatternResolver()
                .getResources("classpath:mapper/tk/*.xml"));
        //分页插件
